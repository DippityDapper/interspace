#include "interspace/server/ServerTestGenerator.hpp"
...
namespace Interspace::Server
{
    ...
    void ServerTestGenerator::GenerateChunk(ServerChunk* chunk)
    {
        for (uint16_t w = 0; w < Game::serverWorld->worldData->CHUNK_SIZE * Game::serverWorld->worldData->CHUNK_SIZE; w++)
        {
            ...
            chunk->tiles.emplace(tilePosition, Game::serverWorld->tileRegistry->GetRandomTileBySeed("grass_stone_path", chunk->tileGen));
        }
