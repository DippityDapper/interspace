...
namespace Interspace
{
    ...
    namespace Client
    {
        void ClientWorld::RequestColonistDeselect(faction_id_t factionId, entity_id_t colonistId)
        {
    ...
    namespace Server
    {
        void ServerWorld::OnColonistDeselectRequestReceived(const std::vector<uint8_t>& data, ENetPeer* from)
        {
            ...
            BroadcastColonistDeselection(false, colonistId, clientId);
        }
    }
}