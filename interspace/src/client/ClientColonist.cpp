...
{
    ClientColonist::ClientColonist()
    {
        sprite = std::make_unique<Engine::Sprite>(position, "assets/colonists/colonist_blue_spritesheet.png", 16, 16, 0, 0);
        sprite->scaleX = 2;
        sprite->scaleY = 2;
    }

    void ClientColonist::RenderName(const std::string& factionName)
    {
        ...
        std::string idStr = name + std::to_string(id);
        ...
        std::string fullName = name + " [" + factionName + "]";
